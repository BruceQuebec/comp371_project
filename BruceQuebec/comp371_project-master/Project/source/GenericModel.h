...
public:
	GenericModel();
	GenericModel(ci_string mName, glm::vec3 mPosition, glm::vec3 mScaling, glm::vec3 mRotationAxis, float mRotationAngleInDegrees);
	virtual ~GenericModel();

	virtual void Update(float dt) = 0;
	//virtual void Draw() = 0;
	virtual void Draw(GLuint & shaderProgramID, Camera camera) = 0;
